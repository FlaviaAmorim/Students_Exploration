 ...
 */
makePieChart()
pieChartView.wedges = [PieWedge(proportion: 0.25, color: .blue),
PieWedge(proportion: 0.25, color: .green),PieWedge(proportion: 0.25, color: .red),
PieWedge(proportion: 0.25, color: .yellow)]
/*:
