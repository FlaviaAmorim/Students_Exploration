...
let number = "30"
let adjective = "game"
let noun1 = "call of duth"
let place = "shopping"
let emotion = "happy"
let negativeEmotion = "desapoint"
let noun = "time"

let history = "Today was a big day for \(name).They had finally saved up \(number) dollars and were going to buy a \(adjective) \(noun1).They went to the \(place)feeling very \(emotion).But then they felt \(negativeEmotion).They were all out of \(noun)"
/*:
